...
const data = [
    ...
    { id: 2, name: "Jane", age: 25, gender: "Female", isFailed: true },
    { id: 3, name: "Bob", age: 35, gender: "Male", isPassed: true },
    { id: 4, name: "Nia", age: 25, gender: "Female", isFailed: true },
...
const filterOptions = [
    ...
    { name: "isPassed", label: "Passed" },
    { name: "isFailed", label: "Failed" },
];

function FilteredTableThree() {
    ...
    const filterData = () => {
        ...
        const filteredData = data.filter((row) => {
            // const d=filteredData.some((val) => row.filterOptions === val);
            if(filters && row.isPassed===true){
                return true;
            }
            else if (filters && row.isFailed ===true){
                return true;
            }
            // return Object.keys(filters).every((key) => {
            //     if (!filters[key]) return true;
...
export default FilteredTableThree;
